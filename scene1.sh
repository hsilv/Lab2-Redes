...
echo -e "${BOLD_WHITE}----------------------ESCENARIO 1----------------------${RESET}"
...
echo -e "${BOLD_WHITE}Escenario 1 (Hamming): $input2${RESET}"
emitter2=$(python3 emitter.py -Ha $input2)
echo -e "${BOLD_MINT_GREEN}Emisor: $emitter2${RESET}"
receiver2=$(./receiver $emitter2 -Ha)
echo -e "${BOLD_CYAN}Receptor: $receiver2${RESET}"

echo -e "\n"

echo -e "${BOLD_WHITE}Escenario 1 (Hamming): $input3${RESET}"
emitter3=$(python3 emitter.py -Ha $input3)
echo -e "${BOLD_MINT_GREEN}Emisor: $emitter3${RESET}"
receiver3=$(./receiver $emitter3 -Ha)
echo -e "${BOLD_CYAN}Receptor: $receiver3${RESET}"

echo -e "\n"

echo -e "${BOLD_WHITE}Escenario 1 (CRC32): $input1${RESET}"
emitter1=$(python3 emitter.py -CRC $input1)
echo -e "${BOLD_MINT_GREEN}Emisor: $emitter1${RESET}"
receiver1=$(./receiver $emitter1 -CRC)
echo -e "${BOLD_CYAN}Receptor: $receiver1${RESET}"

echo -e "\n"

echo -e "${BOLD_WHITE}Escenario 1 (CRC32): $input2${RESET}"
emitter2=$(python3 emitter.py -CRC $input2)
echo -e "${BOLD_MINT_GREEN}Emisor: $emitter2${RESET}"
receiver2=$(./receiver $emitter2 -CRC)
echo -e "${BOLD_CYAN}Receptor: $receiver2${RESET}"

echo -e "\n"

echo -e "${BOLD_WHITE}Escenario 1 (CRC32): $input3${RESET}"
emitter3=$(python3 emitter.py -CRC $input3)
echo -e "${BOLD_MINT_GREEN}Emisor: $emitter3${RESET}"
receiver3=$(./receiver $emitter3 -CRC)
echo -e "${BOLD_CYAN}Receptor: $receiver3${RESET}"
